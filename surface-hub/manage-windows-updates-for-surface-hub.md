...
Новые выпуски операционной системы Surface Hub публикуются через Центр обновления Windows, как и выпуски Windows 10. На этой странице приведены рекомендации по управлению обновлениями для устройств Surface Hub. 

## Центр обновления Windows для бизнеса

Центр обновления Windows для бизнеса — это набор функций, предназначенных для предоставления компаниям дополнительного контроля за тем, как и как устанавливаются пакеты обновления для Windows, а также за счет снижения затрат на управление устройствами. С помощью этого метода устройства Surface Hub непосредственно подключаются к службе Microsoft "Центр обновления Windows".
...
В таблице ниже приведены примеры колец развертывания.
...
Добавьте в список разрешений следующие URL-адреса надежных сайтов Windows Update.
...
Чтобы убедиться, что устройство всегда доступно для использования в рабочее время, Surface Hub выполняет свои административные функции во время заданных периодов обслуживания. В окне обслуживания Surface Hub автоматически устанавливает обновления через центр обновления Windows и перезапускает устройство на 20 минут до конца окна.
