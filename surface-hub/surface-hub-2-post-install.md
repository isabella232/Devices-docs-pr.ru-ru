...
---
# Конфигурация после установки Windows 10 для Surface Hub 2

**Применимо к: Surface Hub 2S** 
...
2.  Введите имя для ярлыка, например " **заблокировать мой компьютер**", а затем нажмите кнопку **"Готово"**.
3.  Щелкните правой кнопкой мыши или нажмите и удерживайте созданный ярлык на рабочем столе и выберите пункт **Свойства**. На вкладке **ярлык** введите в поле **Target** следующее: **Rundll32.exe User32.dll, LockWorkStation**
4.  Нажмите кнопку **изменить значок** и перейдите к **C:\Windows\System32\imageres.dll** и выберите нужный значок. 
5. См. приведенный ниже пример.

    ![Выбор значка](images/lock.png)
6.  Нажмите кнопку **ОК** , чтобы сохранить ярлык.
7.  Щелкните правой кнопкой мыши или коснитесь и удерживайте ярлык и выберите **закрепить на панели задач**.
...
2. Нажмите кнопку **получить обновления**.

### Доска (Майкрософт)

Чтобы установить доску Microsoft, выполните указанные ниже действия.

1. Выберите рабочую область "рукописный ввод в **рабочей области Windows** ![ ](images/ink.png) " в правом правом углу панели задач и скачайте **доску**.
...
3. Настройте значения экрана и спящего режима для вашего предпочтения.
...
3. Разверните раздел **Управление электропитанием** и установите флажок не **применять параметры электроуправления ПИТАНИЕм от ИТ-отдела к этому компьютеру**.
...
9. Проверьте параметры электросети.
10. Убедитесь, что параметры синхронизации отключены.
11. Проверка загрузочных приложений.
...
[Переход на Windows 10 Pro или Enterprise на Surface Hub 2](surface-hub-2s-migrate-os.md)
