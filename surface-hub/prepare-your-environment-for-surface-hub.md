...
Если вы используете Surface Hub в Skype для бизнеса, вам нужно будет открыть дополнительные порты. Следуйте указаниям ниже:
- Если вы используете Skype для бизнеса Online, ознакомьтесь [с разрешениями для IP-адресов и диапазонов IP-адресов в Office 365](https://support.office.com/article/Office-365-URLs-and-IP-address-ranges-8548a211-3fe7-47cb-abb1-355ea5aa88a2?ui=en-US&rs=en-US&ad=US).
- Если вы используете Skype для бизнеса Server, ознакомьтесь [со сведениями о портах и протоколах для внутренних серверов в Skype для бизнеса Server:](https://docs.microsoft.com/SkypeForBusiness/plan-your-deployment/network-requirements/ports-and-protocols). 
- Если вы используете гибридную версию Skype для бизнеса Online и Skype для бизнеса Server, вам нужно будет открыть все документированные порты из [IP-адресов Office 365 и диапазонов IP-адресов](https://support.office.com/article/Office-365-URLs-and-IP-address-ranges-8548a211-3fe7-47cb-abb1-355ea5aa88a2?ui=en-US&rs=en-US&ad=US) и [Skype для бизнеса Server: порты и протоколы для внутренних серверов](https://docs.microsoft.com/SkypeForBusiness/plan-your-deployment/network-requirements/ports-and-protocols?toc=/SkypeForBusiness/toc.json&bc=/SkypeForBusiness/breadcrumb/toc.json).
