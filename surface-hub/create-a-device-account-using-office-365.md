...
# Создание учетной записи устройства с помощью пользовательского интерфейса (Surface Hub 1)
 ...
 > [!NOTE]
 >На этой странице содержатся сведения об исходном Surface Hub (версия 1). Для Surface Hub 2S см. создание [учетной записи устройства Surface Hub 2S.](surface-hub-2s-account.md)
...
-   [Microsoft Online Services Sign-In RTW для ИТ-специалистов](https://www.microsoft.com/download/details.aspx?id=41950)
...
>[!NOTE]
>Этот метод будет работать только при синхронизации из локальной службы Active Directory.
...
>[!NOTE]
>Если вы хотите создать и назначить политику созданной учетной записи и используете Exchange 2010, наберите соответствующую информацию о создании политики и назначении политики при использовании консоли управления Exchange.
