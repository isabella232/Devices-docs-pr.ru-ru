...
### [Технические характеристики Surface Hub 2S](surface-hub-2s-techspecs.md) 
...
### [Настройка после установки Windows 10 для Surface Hub 2](surface-hub-2-post-install.md)
...
### [Журнал изменений для Surface Hub](change-history-surface-hub.md)
