...
---
# <a name="create-provisioning-packages-for-surface-hub"></a>Создание пакетов для Surface Hub
...
1. Откройте Microsoft Excel (или другой редактор .csv), создайте файл .csv с именем SurfaceHubConfiguration.csv
...
> [!TIP]
> Используйте мастер, чтобы создать пакет с общими параметрами, затем переключитесь в расширенный редактор, чтобы добавить другие параметры.<br><br> ![Переключение в расширенный редактор](images/icd-simple-edit.png)

1. Если вы продолжите работу в предыдущем разделе, выберите **Переключатель** на расширенный редактор в противном случае **откройте Windows конструктор** конфигурации и выберите **advanced provisioning**.<br>
  ![Использование расширенной подготовки](images/sh-prov-adv.png)

2. Назови свой проект и выберите **Далее**.
3. Выберите **общие для Windows 10 для совместной работы,** выберите **Далее**, а затем выберите **Готово**.<br>
     ![Новый проект WCD](images/icd-new-project.png)

4. В проекте в **рамках доступных настроек**выберите **параметры Common Team.**<br>
