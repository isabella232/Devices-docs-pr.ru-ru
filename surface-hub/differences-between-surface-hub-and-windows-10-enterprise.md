...
*Политики организации,* которые это может повлиять: - Политики, связанные с разрешениями доступа и владением файлами и папками, не применяются для Surface Hub. Пользователи не могут просматривать и сохранять файлы в системных каталогах и сетевых папках.
