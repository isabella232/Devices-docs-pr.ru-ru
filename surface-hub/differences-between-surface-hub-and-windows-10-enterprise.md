...
*Это может повлиять на следующие политики организации:* <br> Устройствами Surface Hub невозможно управлять, как традиционными ПК. Используйте MDM для настройки параметров, а OMS— для мониторинга Surface Hub.

### Удаленное управление и мониторинг

Surface Hub поддерживает удаленное управление через решения для управления мобильными устройствами (MDM), такие как [Microsoft Intune](https://docs.microsoft.com/intune/) и мониторинг через [монитор Azure](https://azure.microsoft.com/services/monitor/). 
...
Surface Hub не поддерживает групповую политику Windows, в том числе аудит. Вместо этого для применения политик на Surface Hub следует использовать систему MDM. Дополнительные сведения о системе MDM см. в разделе [Управление параметрами Surface Hub с использованием поставщика MDM](manage-settings-with-mdm-for-surface-hub.md).
