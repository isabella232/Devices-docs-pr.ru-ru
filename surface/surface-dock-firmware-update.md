...
---
# Обновление встроенного по Surface Dock (Майкрософт): технические сведения для ИТ – администраторов
...
В этой статье объясняется, как использовать обновление встроенного по Surface Dock для обновления микропрограммы Surface Dock. После установки на устройстве Surface она будет обновлять все стыковочные устройства, подключенные к устройству Surface. 
...
2. Отключите устройство Surface от стыковочного устройства (с помощью адаптера электросети), подождите 5 секунд, а затем снова подключитесь. Обновление встроенного по для Surface Dock автоматически обновит закрепление в фоновом режиме. Процесс может занять несколько минут и продолжаться, даже если он будет прерван. 
...
5. После завершения обновления в реестре Windows появится обновленные значения DWORD, соответствующие текущей версии средства. Подробные сведения приведены в разделе [Справочник по версиям](#versions-reference) в этой статье. Пример
