...
| 3.5 mm Audio in/out                 | Yes                                                         | Да                                                                                                 | Yes              |
...
| Wake-on-LAN from S4/S5 sleep modes  | No                                                          | Да                                                                                                 |          Yes        |
| Network PXE boot                    | Yes                                                         | Да                                                                                                 |        Yes          |
| SEMM host access control            | No                                                          | Да                                                                                                 | No               |
| SEMM port access control<sup>2</sup>          | No                                                          | Да                                                                                                 | No               |
