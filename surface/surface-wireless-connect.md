...
## Настройка точек доступа для оптимальных возможностей роуминга
...
### Рекомендуемые параметры пользователя и рекомендации
...
### Сохранение автоматического параметра по умолчанию для возможности двойной пропускной способности
...
### Параметры агрессивности роуминга на устройствах Surface с адаптерами Intel 
...
### Параметры агрессивности роуминга на Surface Go и Surface Pro X
