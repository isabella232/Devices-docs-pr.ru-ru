...
## Отмена регистрации устройства Surface из SEMM с помощью пакета UEFI Surface Reset
...
## Отмена регистрации устройства Surface из SEMM с запросом на восстановление
