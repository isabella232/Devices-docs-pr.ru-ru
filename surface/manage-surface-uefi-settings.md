...
Все текущие и будущие поколения устройств Surface используют уникальный интерфейс UEFI, разработанный корпорацией Майкрософт специально для этих устройств. Параметры UEFI Surface позволяют включить или отключить встроенные устройства и компоненты, защитить параметры UEFI от изменения и настроить параметры загрузки устройства Surface. 
...
3. Когда на экране появится логотип Microsoft или **** Surface, продолжайте удерживать кнопку "Громкость" до тех пор, пока не появится экран UEFI.
...
Страница "Устройства" позволяет включить или отключить определенные устройства и компоненты, в том числе:
