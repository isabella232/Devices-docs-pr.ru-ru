...
- Surface Pro 4, Surface Pro (5th Gen), Surface Pro 6, Surface Pro 7, Surface Pro 7+ (только коммерческие skUs), Surface Pro 8 (только коммерческие skUs), Surface Pro X
- Surface Laptop (1-й gen), Surface Laptop 2, Surface Laptop 3 (только процессоры Intel), Surface Laptop Go, Surface Laptop 4 (только коммерческие skUs), Surface Laptop SE
- Surface Studio (1-й gen), Surface Studio 2
- Surface Book (все поколения)
- Surface Laptop Studio (только коммерческие skUs)
- Surface Go, Surface Go [21<sup></sup>](#references), Surface Go 3 (только коммерческие skUs)
...
- Специальные символы: !@#$%^&*()?<>{}[]-__+|.;:'"

Пароль должен быть не менее шести символов и быть чувствительным к делу.
...
На странице Security также можно изменить конфигурацию безопасной загрузки устройства Surface. Технология безопасной загрузки предотвращает загрузку несанкционированного кода на устройстве Surface, обеспечивая защиту от заражений буткитами и руткитами. Вы можете отключить безопасную загрузку, чтобы на устройстве Surface можно было загружать сторонние операционные системы и загрузочные носители. Можно также настроить secure Boot для работы с сторонними сертификатами, как показано на рисунке 4. Дополнительные дополнительные информации см. в [см. в "Безопасной загрузке"](/windows-hardware/design/device-experiences/oem-secure-boot).
...
Чтобы указанный порядок загрузки вступил в силу, необходимо установить параметр **Включить** альтернативную последовательность загрузки **,** как показано на рисунке 7.
...
Страница Управление позволяет управлять использованием управления Zero Touch UEFI и другими функциями на соответствующих устройствах, включая Surface Pro 8, Surface Go 3, Surface Laptop Studio, Surface Pro 7+, Surface Pro 7, Surface Pro X, Surface Laptop 4 , Surface Laptop 3, Surface Laptop SE и Surface Book 3. 
...
> [!NOTE]
> Страница ПАРАМЕТРОВ управления UEFI и использование DFCI в настоящее время доступна для Surface Laptop SE, Surface Laptop Studio, Surface Pro 8, Surface Go 3, Surface Laptop 4, Surface Laptop Go, Surface Book 3, Surface Laptop 3, Surface Pro 7+, Surface Pro 7 и Surface Pro X.  Дополнительные новости см. в [руководстве Intune параметров Surface UEFI](surface-manage-dfci-guide.md).
