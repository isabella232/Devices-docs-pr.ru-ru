...
>[!NOTE]
>SEMM доступен только на устройствах с микропрограммой UEFI Surface. Это включает в себя большинство других устройств Surface, в том числе Surface Pro 7, Surface Pro X, Surface Hub 2S и Surface 3 для настольных ПК с процессором Intel. SEMM не поддерживается в версии 15 Surface для настольных ПК с процессором AMD (доступно только в качестве розничного SKU). 
