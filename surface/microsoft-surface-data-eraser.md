...
>[!NOTE]
>При стирании данных Surface на Surface Studio и Surface Studio 2 может потребоваться до 6 минут для загрузки WinPE до тех пор, пока диск стирание не будет удален.
...
1.  Запустите файл установки DataEraserSetup.msi, скачанный из [центра загрузки Майкрософт](https://www.microsoft.com/download/details.aspx?id=46703).
...
4. Выберите USB-накопитель на странице **выбора флэш-накопителя USB** , как показано на рис. 3, а затем нажмите кнопку **начать** , чтобы начать процесс создания USB. Выбранный накопитель будет отформатирован, и все имеющиеся на нем данные будут потеряны.
...
6. После появления экрана **Congratulations** накопитель можно извлечь. Теперь этот накопитель можно вставить в устройство Surface, загрузить с него устройство и стереть данные на устройстве. Нажмите **кнопку Готово,** чтобы завершить процесс создания USB, как показано на рисунке 4.
...
3. После загрузки устройства Surface появится текстовый файл **SoftwareLicenseTerms** , как показано на рисунке 5.
...
В этой версии ластика данных Surface добавляется поддержка: 
- Surface Book 3
- Surface Go 2
- Новый SSD на Surface Go

### 3.28.137
*Дата выпуска: 11 ноября 2019* Эта версия ластика для данных Surface:

- Включает исправления ошибок

### Версия 3.21.137
*Дата выпуска: 21 октября 2019* Эта версия ластика для поверхностей данных скомпилирована для x86 и поддерживает следующие устройства:

- Поддержка Surface Pro 7, Surface Pro X и Surface 3

### Версия 3.2.78.0
*Дата выпуска: 4 декабря 2018*

Эта версия ластика для данных Surface:
...
- Добавлена поддержка в студии Surface Studio 2
- Устранение проблем с SD-картой

### Версия 3.2.69.0
*Дата выпуска: 12 октября 2018 г.*

В этой версии ластика данных Surface добавлена поддержка следующих возможностей:
...
- Дополнительные запоминающие устройства (диски) для мобильных устройств Surface Pro и Surface
