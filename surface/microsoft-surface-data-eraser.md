...
Эта версия ластик Surface Data:
...
Эта версия eraser Surface Data добавляет поддержку для:
...
### <a name="version-321137"></a>Версия 3.21.137

*Дата выпуска: 21 октября 2019 г.*

Эта версия стиратель surface Data компилироваться для x86 и добавляет поддержку для следующих устройств:

- Surface Pro 7, Surface Pro X и Surface Laptop 3

### <a name="version-32780"></a>Версия 3.2.78.0
...
### <a name="version-32750"></a>Версия 3.2.75.0

*Дата выпуска: 12 ноября 2018 г.*

Эта версия ластик Surface Data:

- Добавляет поддержку Surface Studio 2
- Устранение проблем с SD-картой

### <a name="version-32690"></a>Версия 3.2.69.0

*Дата выпуска: 12 октября 2018 г.*

Эта версия eraser Surface Data добавляет поддержку для следующих версий:

- Surface Pro 6
- Surface Laptop 2

### <a name="version-32680"></a>Версия 3.2.68.0

В этой версии Microsoft Surface Data Eraser добавлена поддержка следующих устройств:

- Surface Go

### <a name="version-32580"></a>Версия 3.2.58.0

В этой версии Microsoft Surface Data Eraser добавлена поддержка следующих устройств:

- Дополнительные устройства хранения (диски) для Surface Pro и Surface Laptop устройств

### <a name="version-32460"></a>Версия 3.2.46.0

В этой версии Microsoft Surface Data Eraser добавлена поддержка следующих устройств:

- Surface Pro с функцией LTE Advanced

### <a name="version-32450"></a>Версия 3.2.45.0
...
### <a name="version-32360"></a>Версия 3.2.36.0
