...
Развертывание с помощью Autopilot имеет несколько преимуществ: оно позволяет использовать операционную систему с заводской подготовкой, оптимизированную для автоматического развертывания, и включить предварительную установку [Приложений Microsoft 365 для предприятий](https://www.microsoft.com/microsoft-365/enterprise/microsoft-365-apps-for-enterprise).

Организации, уже использующие современные решения по управлению, безопасности и повышению производительности, с легкостью смогут воспользоваться уникальными функциями повышения производительности в Surface Pro X. Пользователи, использующие современные [бизнес-приложения](/microsoft-store/working-with-line-of-business-apps), [приложения Microsoft Store (UWP)](/windows/uwp/get-started/universal-application-platform-guide) или решения для удаленных рабочих столов, также могут воспользоваться этими преимуществами.

## <a name="image-based-deployment-considerations"></a>Соображения по поводу использования развертывания из образа

Microsoft Deployment Toolkit (MDT) и Microsoft Endpoint Configuration Manager (ранее System Center Configuration Manager) не поддерживают Surface Pro X для развертывания операционной системы. Пользователям, применяющим развертывание на основе образа, следует рассмотреть Surface Pro 8, пока они продолжают оценивать подходящее время для перехода на современные решения для развертывания. 

## <a name="managing-surface-pro-x-devices"></a>Управление устройствами Surface Pro X

### <a name="intune"></a>Intune

[Microsoft Intune](/intune) интегрируется с Azure Active Directory для управления удостоверениями и доступом и предоставляет возможности подробного управления зарегистрированными устройствами Surface Pro X. Параметры политики управления мобильными устройствами (MDM) Intune имеет несколько преимуществ по сравнению с более ранними локальными средствами, такими как групповая политика Windows. К ним относятся ускорение входа в систему устройства и упрощенный каталог параметров политики, обеспечивающие полное управление устройствами из облака. Например, вы можете [управлять LTE с помощью профилей eSIM](/windows/client-management/mdm/esim-enterprise-management) для настройки планов данных и развертывания кодов активации для нескольких устройств.

### <a name="co-management"></a>Совместное управление

После развертывания в Autopilot вы можете присоединить устройства Surface Pro X к Azure AD или Active Directory ([гибридное присоединение к Azure AD](/azure/active-directory/devices/concept-azure-ad-join-hybrid)), где вы можете [управлять устройствами с помощью Intune](/mem/intune/remote-actions/device-management) или [совместно управлять ими с помощью Endpoint Configuration Manager](/mem/configmgr/comanage/overview), который установит 32-разрядный клиент x86 ConfigMgr.

### <a name="third-party-mdm-solutions"></a>Сторонние решения MDM
...
Microsoft Defender поможет защитить Windows 10 и Windows 11 на компьютерах на базе ARM в течение поддерживаемого жизненного цикла устройства. 

Некоторое антивирусное ПО сторонних разработчиков нельзя установить на устройствах с процессором на базе ARM. Взаимодействие со сторонними поставщиками антивирусных программ для обеспечения готовности антивирусной программы для компьютеров на базе ARM продолжается. Обратитесь к поставщику антивирусной программы, чтобы узнать, когда его приложения будут доступны.
...
Surface Pro X был спроектирован с учетом использования Центра обновления Windows, чтобы упростить обновление драйверов и встроенного ПО для домашних пользователей и пользователей в небольших компаниях. Используйте параметры по умолчанию для получения автоматических обновлений.  Проверка:
...
- Обратите внимание, что службы WSUS не поддерживают доставку драйверов и встроенного ПО на Surface Pro X.
...
- Приложения, использующие драйверы, которые предназначены для компьютеров с Windows 10 или Windows 11 c процессорами на базе ARM.
- Эмуляция x64 для Windows теперь общедоступна в Windows 11.
...
Виртуальный рабочий стол Azure обеспечивает доступ к рабочим столам, приложениям и данным Windows на любых вычислительных устройствах или платформах из любого местоположения. Для получения дополнительных сведений см. сайт [Виртуальный рабочий стол Azure](https://aka.ms/wvd). 
...
- Firefox и Microsoft Edge на основе Chromium по умолчанию работают с повышенной производительностью на компьютерах с Windows 10 или Windows 11 на базе ARM.

## <a name="installing-and-using-microsoft-office"></a>Установка и использование Microsoft Office

- Используйте Office 365 для наилучшего взаимодействия с компьютерами Windows 10 или Windows 11 с процессором на базе ARM.
- Технология Office 365 "нажми и работай" устанавливает Outlook, Word, Excel и PowerPoint, оптимизированные для работы на компьютере Windows 10 или Windows 11 с процессором на базе ARM.
...
В приведенных ниже таблицах показана доступность выбранных основных функций на Surface Pro X с Windows 10 или Windows 11 на базе ARM.
...
| --------------------------------------------- | ------- | ------------------------------------------------------------------------------------- |
| BitLocker                                     | Да     |                                                                                       |
| Microsoft Defender                            | Да     |                                                                                       |
| Поддержка сторонних антивирусных программ             | См. примечание.| Некоторое антивирусное ПО сторонних разработчиков нельзя установить для процессоров на базе ARM. Обратитесь к поставщику антивирусной программы, чтобы узнать, когда его приложения будут доступны. |
