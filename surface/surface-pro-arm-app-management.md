...
Развертывание с помощью Autopilot имеет несколько преимуществ: оно позволяет использовать операционную систему с заводской подготовкой, оптимизированную для автоматического развертывания, и включить предварительную установку корпоративной версии приложений Microsoft 365 (также известной как Office профессиональный плюс).
